...
# kernel_ar = torch.from_numpy(kernel_10)
...
#     noise = np.random.normal(0, sigma, len(f_10))
#     f_d = f_10 + noise
...
# np.save('C:/python/inverse/7_10/mls_beta_0_9.npy', alpha_opt)
